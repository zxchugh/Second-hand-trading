			...
			<td bgcolor="#FFFFFF"><s:form
					...
					<table width="60%" border="0" align="center" cellpadding="4"
						...
						<tr align="center" bgcolor="#F2FDFF">
							<td align="left" colspan="2" class="optiontitle">Modify the website announcement<input
						...
						<tr align="center" bgcolor="#F2FDFF">
							...
							<td align="left"><input type="text" name="article.image"
								style="width: 160px" id="image" value="${article.image}" onclick="selimage();" readonly="readonly" /></td>
						</tr>
						<tr align="center" bgcolor="#F2FDFF">

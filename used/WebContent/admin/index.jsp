...
<base href="<%=basePath%>" />
<title>Second-hand trading platform on campus</title>
<STYLE type=text/css>
body {
	FONt-SIZE: 12px;
	BACKGROUND: #E8F2FB;
							...
							<tbody>
								<tr>
									<td width=460 background=images/login_top.jpg height=54
										class="bt">Second-hand trading platform on campus</td>
								</tr>
								<tr>
												...
												<tr>
													...
													<td>
														<table cellSpacing=1 cellPadding=2 width="100%"
															...
															<tbody>
																<tr>
																	<td align=right width=60 height=30>Username:</td>
																	<td height=30><input id="username"
																		name="admin.username"></td>
																</tr>
																<tr>
																	<td align=right height=30>pass&nbsp;&nbsp;word:</td>
																...
																<tr align="center">
																	<td colSpan=2 height=40><input class="btn"
																		...
																		class="btn" type="reset" value="Cancel" name="reset">
																	</td>
																</tr>
															</tbody>
														</table>
								...
								<tr>
									<td align=middle bgColor=#9CBFE5 height=25>2019 &copy;
										Second-hand trading platform on campus All Rights Reserved</td>
								</tr>
							</tbody>
						</table>
					</td>

		...
		<tr valign="top">
			<td bgcolor="#FFFFFF"><table width="96%" border="0"
					...
					<tr align="left" bgcolor="#F2FDFF">
						<td colspan="20" class="optiontitle">Seller information list</td>
					</tr>
					<tr align="center">
						...
						<td align="center" bgcolor="#ebf0f7">KaKao</td>
					...
					<s:iterator value="list" id="list">
						<tr align="center" bgcolor="#FFFFFF">
							...
							<td align="center"><s:property value="KaKao" /></td>
					...
					<tr align="right" bgcolor="#ebf0f7">
						<td colspan="20"><form
								action="seller/querySellerByCond.action" name="myform"
								method="post">
								Query conditions<select name="cond" style="width: 100px"><option
										value="username">Searching by username</option>
									<option value="realname">Searching by realname</option>
									<option value="sex">Searching by gender</option>
									<option value="birthday">Searching by birthday</option>
									<option value="contact">Searching by contact</option>
									<option value="KaKao">Searching by KaKao</option>
									<option value="status">Searching by status</option>
									<option value="regdate">Searching by registration date</option></select>Keyword<input type="text"

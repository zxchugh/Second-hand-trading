			...
			<td bgcolor="#FFFFFF"><table width="96%" border="0"
					...
					<s:iterator value="list" id="list">
						<tr align="center" bgcolor="#FFFFFF">
							...
							<td align="center">
							<s:if test="status == 'Locking'">
							<s:a href="seller/status.action?id=%{sellerid}">Unlock</s:a>|
							</s:if>
							<s:if test="status == 'Unlock'">
							<s:a href="seller/status.action?id=%{sellerid}">Locking</s:a>|
							</s:if>
							<s:a
									href="seller/deleteSeller.action?seller.sellerid=%{sellerid}"

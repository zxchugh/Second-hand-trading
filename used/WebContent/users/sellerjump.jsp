						...
						<div class="userCenterBox boxCenterList clearfix" style="_height: 1%;">
							...
							<table width="100%" border="0" cellpadding="5" cellspacing="1" bgcolor="#dddddd">
								<tr>
									...
									<th align="center" bgcolor="#ffffff">Wanted category</th>
								...
								<tr>
									...
									<td align="center" bgcolor="#ffffff"><a href="users/message.html">
									<textarea rows="1" cols="20" name="content"></textarea><input type="submit" value="Message"></a></td>
								</tr>
								<tr>
								...
								<s:iterator value="map.ordersList">
									<tr>
										...
										<td  align="center" bgcolor="#ffffff"><s:property value="goods.list" /></td>
										<td  align="center" bgcolor="#ffffff"><s:property value="message" /></td>
